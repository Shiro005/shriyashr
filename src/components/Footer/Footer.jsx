            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="text-center md:text-left mb-4 md:mb-0">
                        <h2 className="text-xl font-bold text-amber-600">Shriyash Rulhe</h2>
                        <p>Founder of WebReich</p>
                    </div>
                    <div className="flex justify-center space-x-4 mb-4 md:mb-0">
                        <Link to="/" className="hover:text-gray-950 text-base font-semibold text-gray-500">Home</Link>
                        <Link to="/about" className="hover:text-gray-950 text-base font-semibold text-gray-500">About</Link>
                        <Link to="/projects" className="hover:text-gray-950 text-base font-semibold text-gray-500">Projects</Link>
                        <Link to="/contact" className="hover:text-gray-950 text-base font-semibold text-gray-500">Contact</Link>
                        <Link to="/coffee" className="hover:text-gray-950 text-base font-semibold text-gray-500">Coffee</Link>
                    </div>
                    <div className="flex justify-center space-x-4 items-center">
                        ...
                        <Link to="/coffee" aria-label="Coffee" className="hover:text-gray-600">
                            <img src="https://cdn-icons-png.flaticon.com/128/1014/1014342.png" alt="" height={28} width={28}/>
                        </Link>
                    </div>
                </div>
